...
ui <- navbarPage(
  ...
  navbarMenu(
    ...
    tabPanel("TF Regulated Interaction in TRM/TEXterm",
             fluidRow(
               column(
                 12,
                 align = "center",
               ...
               fluidRow(column(
                 width = 12,
                 align = "center",
                 textInput("search_tfregulated_data", label = "Search", placeholder = "Enter interested regulator name...")
               )),
    ...
    tabPanel("Search Individual TF Communities",
             fluidRow(
               column(
                 12,
                 align = "center",
                 tags$h1("Search Individual TF Communities"),
                 br(),
                 tags$img(
                   src = "placeholder.jpg",
                   style = "max-width: 80%; height: auto;",
                 ...
                 p("place for search box and search names for images to pop up")
               )
             )),
  ),
